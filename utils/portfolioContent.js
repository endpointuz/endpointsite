  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        id: 4,
        type: 'text',
        content: 'Мы сделали сайт с максимально простым и удобным интерфейсом. Аккуратно и красиво, с минимальным количеством кликов можно заказать любые интересующие услуги и выбрать нужный тариф',
      },
      {
        id: 5,
        type: 'image',
