              ...
              <Col lg={7} xl={7}>
                <header className="projects-header">
                  ...
                  <p className="page-header-description">
                    Наша команда объединилась вокруг главной идеи - создавать максимально
                    простые, но в то же время удобные продукты, облегчающие рутинные
                    работы и делающий жизнь комфортнее.
                  </p>
                  <p className="page-header-description">
                    Благодаря этому мы разработали собственные
                    некоммерческие проекты и инструменты, которыми мы гордимся.
                  </p>
                </header>
              </Col>
            </Row>
